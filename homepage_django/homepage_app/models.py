...
class Member(models.Model):
    ...
    mem_image = models.ImageField(upload_to='homepage/img/member', null=True)
...
class Team(models.Model):
    ...
    team_image = models.ImageField(upload_to='homepage/img/team', null=True)
...
class TFT(models.Model):
    ...
    tft_image = models.ImageField(upload_to='homepage/img/tft', null=True)
...
class News(models.Model):
    ...
    news_image = models.ImageField(upload_to='homepage/img/news', null=True)
